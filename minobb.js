...
function MinAreaEnclosingRect(convexHull)
{
    ...
    {  
        var obbUpperLeft = this.IntersectLines(leftStart, leftDir, topStart, topDir);
        var obbUpperRight = this.IntersectLines(rightStart, rightDir, topStart, topDir);
        var obbBottomLeft = this.IntersectLines(bottomStart, bottomDir, leftStart, leftDir);
        var obbBottomRight = this.IntersectLines(bottomStart, bottomDir, rightStart, rightDir);
    ...
    this.IntersectLines = function(start0, dir0, start1, dir1)
    {
